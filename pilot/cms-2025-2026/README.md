...
| File | What it is |
|------|------------|
| [`advisory-plan.md`](advisory-plan.md) | The original plan: goal, 7-book curriculum with hours, time commitments, venues, field trips |
| [`meeting-notes.md`](meeting-notes.md) | Agendas, assignments, and notes from every call, oldest to newest |
| `originals/` | The source Word documents, unchanged |

## Timeline

| Phase | Dates | Focus |
|-------|-------|-------|
| Business advisory | Oct 15 – Nov 12, 2025 | Process areas, friction points, Four Quadrants, P&L and budget |
| Kickoff | Dec 17, 2025 | Advisory plan reviewed; *Start with Why* assigned |
| *Start with Why* | Jan 14, 2026 | Golden Circle; label team as Why / How / What |
| *Tribal Leadership* | Jan 21 – Feb 19, 2026 | Parts 1–4; Tribal Stage Audit; build 3–4 triad teams |
| *Unreasonable Hospitality* | Mar 19, 2026 | 4 hospitality actions before CyberMarketingCon; a committee |
...
- **Field trips and 1:1s** were in the plan but never happened during the pilot.
- **A recurring meeting format came out of it:** Roundup → What's new → Book review → Assignment → Next up. See the session template in [`../../program/program-design.md`](../../program/program-design.md).
